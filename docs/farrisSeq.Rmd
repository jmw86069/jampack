...
txListsAllDF <- data.frame(geneListsAll=lengths(geneListsAll),
   ...
   txListsAllTPMdet=lengths(txListsAllTPM),
   non_coding=lengths(txListsAllTPMncDet),
   pct_non_coding=lengths(txListsAllTPMncDet)/lengths(txListsAllTPM),
   protein_coding=lengths(txListsAllTPMcdsDet),
   pct_protein_coding=lengths(txListsAllTPMcdsDet)/lengths(txListsAllTPM),
...
## Rename labels
## CBonly -> "Cell Body Retained"
## non-pyramidal -> "Non-Pyramidal"
## CB1andDE1 -> "High-Confidence Dendritic"
