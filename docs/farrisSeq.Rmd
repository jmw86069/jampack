...
```{r cajigas_genes}
loadObject("farrisElifeGenes");
loadObject("farrisAinsleyDEgenes");
loadObject("cajigasNeuropilFilteredDetected");
```
...
vps <- vennPlotSets(list(
  Farris=CA1detCBandDE,
  Cajigas=cajigasNeuropilFilteredDetected,
  Ainsley=farrisAinsleyDEgenes,
  Nakayama=farrisElifeGenes));
```
